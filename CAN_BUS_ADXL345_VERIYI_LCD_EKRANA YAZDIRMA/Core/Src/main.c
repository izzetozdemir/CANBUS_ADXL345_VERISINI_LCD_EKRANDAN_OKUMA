  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	 ...
	 z=dizi[2];
		 ...
		 lcd_send_cmd(0xc0);
		 lcd_send_data(x / 100 + 48);
		 lcd_send_data((x / 10) % 10 + 48);
		 lcd_send_data(x % 10 + 48);

		// lcd_send_cmd(0x80);
		// lcd_send_string(" Y eksen: ");
		 lcd_send_cmd(0xc5);
		 lcd_send_data(y / 100 + 48);
		 lcd_send_data((y / 10) % 10 + 48);
		 lcd_send_data(y % 10 + 48);


		// lcd_send_cmd(0x80);
		// lcd_send_string("Z eksen: ");
		 lcd_send_cmd(0xcA);
		 lcd_send_data(y / 100 + 48);
		 lcd_send_data((y) % 10 + 48);
		 lcd_send_data(y % 10 + 48);
